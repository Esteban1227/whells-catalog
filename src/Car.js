    ...
    <group {...props} dispose={null}>
      <group position={[0, 0.212, -0.034]} rotation={[-1.571, 0, 0]}>
        <mesh
          ...
          material={materials.carpaint_metalic_white}
          position={[0, 1.493, -0.211]}
      ...
      <group position={[0.803, 0.353, 1.627]} rotation={[0.377, 0, 0]}>
        <mesh
          geometry={nodes.wheelFtL.geometry}
          material={materials.tire}
          position={[-0.803, 3.153, -0.352]}
          rotation={[Math.PI / 2, Math.PI / 2, 0]}
          scale={0.001}>
          <mesh
          ...
          />
          <mesh
            geometry={nodes.palstic.geometry}
            material={materials.plastic_shiny_black}
            position={[0.001, 0, 0]}
          />
          <mesh
      ...
      <group position={[-0.817, 0.353, 1.627]} rotation={[0.377, 0, 0]}>
        <mesh
          geometry={nodes.wheelFtR.geometry}
          material={materials.tire}
          position={[0.817, 3.153, -0.352]}
          rotation={[-Math.PI / 2, Math.PI / 2, 0]}
          scale={-0.001}>
          <mesh
      ...
      <group position={[-0.817, 0.352, -1.526]} rotation={[0.377, 0, 0]}>
        <mesh
          geometry={nodes.wheelBkR.geometry}
          material={materials.tire}
          position={[0.817, 0, -0.352]}
          rotation={[-Math.PI / 2, Math.PI / 2, 0]}
          scale={-0.001}>
      ...
      <group position={[0.803, 0.353, 1.627]} rotation={[-1.571, 0, 0]}>
        <mesh
          geometry={nodes.wheelbrakeFtL.geometry}
      ...
      <group position={[-0.817, 0.353, 1.627]} rotation={[-1.571, 0, 0]}>
        <mesh
          geometry={nodes.wheelbrakeFtR.geometry}
          material={materials.paint_brake}
          position={[0.817, 3.153, -0.352]}
          rotation={[-Math.PI / 2, Math.PI / 2, 0]}
          scale={-0.001}
      ...
      <group position={[-0.817, 0.352, -1.526]} rotation={[-1.571, 0, 0]}>
        <mesh
          geometry={nodes.wheelbrakeBkR.geometry}
          material={materials.paint_brake}
          position={[0.817, 0, -0.352]}
          rotation={[-Math.PI / 2, Math.PI / 2, 0]}
          scale={-0.001}
